...
const JumbotronGlobal = () => {
  return (
    <section className="bg-gradient-to-b from-[#004DE8] to-[#0148d7] text-white py-16 px-4 md:px-8 items-center">
      <div className="">
        <div className="container mx-auto mt-16 flex flex-col md:flex-row items-center gap-8">
          {/* Left Content */}
          <div className="md:w-1/2">
            ...
            <p className="mt-4 text-lg">
              ...
              on various topics. Stay informed and inspired as we explore the
              world of technology, creativity, and innovation.
            </p>
            <Link href="/blogs">
